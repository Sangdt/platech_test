...
module.exports = {
  content: [
    ...
    './node_modules/tocbot/**/*.{js,jsx,ts,tsx}',
    './node_modules/react-tabs/**/*.{js,jsx,ts,tsx}',
    './node_modules/react-multi-carousel/**/*.{js,jsx,ts,tsx}',
    './node_modules/react-block-ui/**/*.{js,jsx,ts,tsx}',
    './node_modules/react-glider/**/*.{js,jsx,ts,tsx}',
    './node_modules/glider-js/**/*.{js,jsx,ts,tsx}',
  ],
  safelist: [
    'text-yellow-300','text-gray-500','text-gray-400', 'table-auto', 'lazyload', 'text-teal-300','text-4xl'
  ],
  // important: true,
