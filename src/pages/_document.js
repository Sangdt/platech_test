...
function getCsp(nonce) {
  ...
  csp += `style-src 'self' 'unsafe-inline'  'nonce-${nonce}' https://www.google.com https://www.google-analytics.com https://maps.gstatic.com https://connect.facebook.net https://fonts.googleapis.com data:;`; // NextJS requires 'unsafe-inline'
