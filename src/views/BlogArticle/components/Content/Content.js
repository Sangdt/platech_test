...
const Content = ({blogBody}) => {
  // console.log('ALLOWED_TAkG_LIST',ALLOWED_TAG_LIST);
  // const theme = useTheme();
  // const isMd = useMediaQuery(theme.breakpoints.up('md'), {
  //   defaultMatches: true,
  // });

//   const blogBody =`<blockquote
//   id="2">“So many teams struggle to make their onboarding experience anywhere near as good as their core product, so
//   the results of this is poor retention”</blockquote>
// <h5 >Big heading
//   for a new topic</h5>
...
// <h5>Small
//   heading for a smaller transition</h5>
// <p >Lorem ipsum dolor sit amet,
...
// const BlogPostHeaderImage = ({ }) => {
//   const theme = useTheme();
//   return (<Box width={1} height={1} marginY={4}>
//     <LazyLoadImage
//       height={'100%'}
//       width={'100%'}
...
// const EndBlogNoted = ({ }) => {
//   return (<Box paddingX={{ xs: 0, sm: 4, md: 6 }} paddingY={4}>
