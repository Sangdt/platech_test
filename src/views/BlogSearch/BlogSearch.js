...
const BlogSearch = ({ pageTitle, pageDescription, blogList, selectOptions }) => {
  ...
  return (
    <>
      <Box bgcolor={'alternate.main'}>
        ...
        <Container paddingY={2}>
          {/* <Breadcrumb /> */}
          <PageBanner pageTitle={pageTitle} pageDescription={pageDescription} />

        </Container>
      </Box>
      <Container>
        {blogList && checkArrNotEmpty(blogList) && <Result blogList={blogList} />}
      </Container>
      <Box
        position={'relative'}
        marginTop={{ xs: 4, md: 6 }}
